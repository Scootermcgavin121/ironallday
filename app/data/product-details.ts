...
export const productDetails: Record<string, ProductDetails> = {
  ...
  "retatrutide-20mg": {
    longDescription:
      `<p>Retatrutide represents a significant advance in metabolic pathway research as the first triple-agonist peptide targeting GLP-1, GIP, and glucagon receptors simultaneously. This unique multi-receptor profile enables researchers to study synergistic metabolic signaling that single- or dual-agonist compounds cannot replicate.</p><h3>What is Retatrutide?</h3><p>Retatrutide (LY3437943) is a synthetic peptide that activates three distinct receptor systems involved in energy homeostasis: the glucagon-like peptide-1 (GLP-1) receptor, the glucose-dependent insulinotropic polypeptide (GIP) receptor, and the glucagon receptor (GCGR). Developed by Eli Lilly, it has generated substantial research interest for its ability to modulate multiple metabolic pathways in preclinical and clinical trial settings.</p><h3>Research Highlights</h3><p>The triple-agonist mechanism enables investigation of how combined incretin and glucagon signaling influences glucose turnover, lipid metabolism, and energy expenditure. The glucagon receptor component is of particular interest to researchers studying thermogenesis and fatty acid mobilization — pathways less accessible with GLP-1-only compounds. Phase 2 clinical trial data published in the New England Journal of Medicine demonstrated significant effects on body composition parameters, generating widespread research community interest.</p><h3>Why Researchers Choose Retatrutide</h3><p>Retatrutide offers a unique multi-target research tool unavailable from mono-agonist compounds. Its well-characterized receptor pharmacology, published clinical data, and novel mechanism make it an essential compound for investigators studying the interplay between incretin and glucagon signaling systems.</p>`,
    properties: {
  ...
  "ipamorelin-5mg": {
    longDescription:
      `<p>Ipamorelin is one of the most studied growth hormone secretagogues (GHS) in peptide research. As a selective agonist of the ghrelin/GHS receptor, it stimulates growth hormone (GH) release from the pituitary without significantly affecting cortisol or prolactin levels — a selectivity profile that makes it highly valued in endocrine research.</p><h3>What is Ipamorelin?</h3><p>Ipamorelin is a synthetic pentapeptide (Aib-His-D-2-Nal-D-Phe-Lys-NH₂) that acts as a GH secretagogue by binding the growth hormone secretagogue receptor (GHS-R1a). First described by Raun et al. in 1998, it was developed as an improvement over earlier GHS compounds due to its remarkable selectivity — it stimulates GH release without triggering the ACTH and cortisol responses seen with hexarelin and GHRP-6.</p><h3>Research Highlights</h3><p>Preclinical studies demonstrate that ipamorelin produces dose-dependent GH release with a potency comparable to GHRP-6, but with significantly fewer off-target endocrine effects. In vitro and animal model research has shown that ipamorelin does not significantly alter FSH, LH, PRL, TSH, ACTH, or cortisol at GH-releasing doses — a selectivity profile unique among GHS peptides. Additional research has explored its effects on gastric motility, bone mineral density in experimental models, and its potential as a research tool for studying the GH/IGF-1 axis.</p><h3>Why Researchers Choose Ipamorelin</h3><p>The combination of potent GH secretion and minimal off-target hormonal effects makes ipamorelin the preferred GHS for controlled studies of the somatotropic axis. Its well-characterized pharmacology and clean endocrine profile provide researchers with a precise tool for investigating GH-dependent pathways.</p>`,
    properties: {
      chemicalFormula: "C₃₈H₄₉N₉O₅",
  ...
  "ghk-cu-100mg": {
    longDescription:
      `<p>GHK-Cu (Glycyl-L-Histidyl-L-Lysine Copper) is a naturally occurring copper peptide first identified in human plasma by Dr. Loren Pickart in 1973. It has since become one of the most extensively studied peptides in skin biology and wound healing research, with over 60 published studies documenting its diverse biological activities.</p><h3>What is GHK-Cu?</h3><p>GHK-Cu is a tripeptide-copper complex that occurs naturally in human plasma, saliva, and urine. Plasma levels decline with age — from approximately 200 ng/mL at age 20 to 80 ng/mL by age 60 — making it a subject of intense interest in aging biology research. The copper ion is essential to the peptide's biological activity, serving as a cofactor for numerous enzymatic processes.</p><h3>Research Highlights</h3><p>Research has demonstrated that GHK-Cu stimulates collagen synthesis (types I and III), promotes decorin production, and enhances the activity of metalloproteinases involved in tissue remodeling. In vitro studies show it increases fibroblast and keratinocyte proliferation, promotes angiogenesis, and upregulates integrin expression — all key components of the wound healing cascade. Gene expression studies by Pickart et al. revealed that GHK-Cu modulates the expression of over 4,000 human genes, with notable effects on genes involved in DNA repair, antioxidant response, and stem cell biology.</p><h3>Why Researchers Choose GHK-Cu</h3><p>GHK-Cu's naturally occurring status, well-characterized copper-dependent mechanism, and broad spectrum of documented biological activities across skin, tissue remodeling, and aging pathways make it an indispensable tool in dermatological and regenerative medicine research.</p>`,
    properties: {
  ...
  "wolverine-bpc157-tb500": {
    longDescription:
      `<p>The BPC-157 + TB-500 blend — commonly referred to as the "Wolverine Blend" — combines two of the most extensively studied tissue repair peptides into a single research compound. This combination allows investigators to study the synergistic effects of two mechanistically distinct repair pathways simultaneously.</p><h3>What is the Wolverine Blend?</h3><p>This blend pairs BPC-157 (Body Protective Compound-157), a 15-amino-acid peptide derived from human gastric juice, with TB-500, a synthetic fragment representing the active region of Thymosin Beta-4. Each component has been individually studied in hundreds of preclinical investigations. BPC-157 primarily modulates the nitric oxide system and VEGF expression, while TB-500 acts through actin dynamics and cellular migration — creating complementary mechanisms of action.</p><h3>Research Highlights</h3><p>Individual studies on BPC-157 have demonstrated accelerated tendon and muscle healing in rodent models, with significant effects on angiogenesis and growth hormone receptor upregulation. TB-500 research shows enhanced cellular migration, anti-inflammatory pathway modulation, and improved tissue remodeling through its effects on the G-actin/F-actin balance. The combination is studied for potential synergistic effects where BPC-157's cytoprotective and vascular mechanisms complement TB-500's structural repair and anti-inflammatory pathways.</p><h3>Why Researchers Choose This Blend</h3><p>The Wolverine Blend provides a dual-mechanism research tool that addresses both the vascular/growth factor and structural/inflammatory aspects of tissue repair in a single compound, enabling more efficient experimental designs.</p>`,
    properties: {
